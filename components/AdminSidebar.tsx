...
const menuItems = [
    ...
    // GROUP: TRANSAKSI & KOMUNIKASI (PALING SERING DIAKSES)
    {
            ...
            <div className="sidebar-section mt-auto">
                ...
                <nav className="sidebar-nav">
                    {settingItems.map((item) => {
                        ...
                        return (
                            <Link key={item.href} href={item.href} className={`sidebar-nav-item ${isActive(item.href) ? "admin-active" : ""}`}>
                                {item.icon}
                                {item.label}
                            </Link>
                        );
            ...
            <div className="sidebar-footer p-4">
                <div className="bg-[#1e293b] p-4 rounded-lg border border-gray-700/50">
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed">
                        Check messages and overdue books daily to maintain library circulation.
                    </p>
                </div>
            </div>
        </aside>
